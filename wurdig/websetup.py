...
def setup_app(command, conf, vars):
    ...
    pyylons = model.Tag(name=u"Pylons", path='pylons')
    science = model.Tag(name=u"Science", path='science')
    arduino = model.Tag(name=u"Arduino", path='adruino')
    maxmsp = model.Tag(name=u"Max/MSP", path='max')
    movement = model.Tag(name=u"Movement", path='movement')
    godel = model.Tag(name=u"godel", path='godel')
    ...
    styleguide.path = u'comment-styleguide'
